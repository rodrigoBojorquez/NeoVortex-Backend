...
public class JwtService : ITokenService
{
    ...
    private readonly NeoVortexDbContext _context;
    private readonly IPermissionRepository _permissionRepository;

    public JwtService(IRoleRepository roleRepository, IConfiguration config, NeoVortexDbContext context,
    ...
    public async Task<string> GenerateTokenAsync(User user)
    {
        ...
        var claims = new List<Claim>
        {
            ...
            new(NeoVortexConstants.PermissionsClaim, string.Join(",", permissions.Select(p => new FormattedPermission(p).ToString())))
        };
